...
//  Create Numbering list for Hours, Minutes, Seconds and AM/PM respectly
...
// Assiging task to Set The Alarm Button  
function setAlarm() {
    document.querySelector("#alarm-h3").innerText = "List_of_Alarms";
    let time = `${selectMenu[0].value}:${selectMenu[1].value}:${selectMenu[2].value}:${selectMenu[3].value}`;
    
    //  Note:-  alarmTime = alarmListArray;
...
// Assiging task to Delete Alarm From List
